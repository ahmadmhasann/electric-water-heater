...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=counter.c dio.c display.c eeprom_external.c i2c.c main.c scheduler.c ssd.c timer.c switch.c adc.c pwm.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/counter.p1 ${OBJECTDIR}/dio.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/eeprom_external.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/scheduler.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/switch.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/pwm.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/counter.p1.d ${OBJECTDIR}/dio.p1.d ${OBJECTDIR}/display.p1.d ${OBJECTDIR}/eeprom_external.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/scheduler.p1.d ${OBJECTDIR}/ssd.p1.d ${OBJECTDIR}/timer.p1.d ${OBJECTDIR}/switch.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/pwm.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/counter.p1 ${OBJECTDIR}/dio.p1 ${OBJECTDIR}/display.p1 ${OBJECTDIR}/eeprom_external.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/scheduler.p1 ${OBJECTDIR}/ssd.p1 ${OBJECTDIR}/timer.p1 ${OBJECTDIR}/switch.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/pwm.p1

# Source Files
SOURCEFILES=counter.c dio.c display.c eeprom_external.c i2c.c main.c scheduler.c ssd.c timer.c switch.c adc.c pwm.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/electric-water-heater.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
